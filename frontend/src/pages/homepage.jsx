      ...
      <CardGroup className="text-center">
        <Card style={{padding: '10px'}}>
          <FontAwesomeIcon
            icon={faChartLine}
            size="8x"
            style={{ color: "lightskyblue", width: '100%' }}
          />
          <Card.Body>
            <Card.Title>Track your projects</Card.Title>
            <Card.Text>
              On this site you can track all of your current and past projects!
              You can set a start date end date of all projects and track your
              progress.
            </Card.Text>
          </Card.Body>
        </Card>
        <Card style={{padding: '10px'}}>
          <FontAwesomeIcon
            icon={faSmile}
            size="8x"
            style={{ color: "lightseagreen", width: '100%'  }}
          />
          <Card.Body>
        ...
        <Card style={{padding: '10px'}}>
          <FontAwesomeIcon
            icon={faTasks}
            size="8x"
            style={{ color: "lightsteelblue", width: '100%'  }}
          />
          <Card.Body>
            <Card.Title>Project Management</Card.Title>
            <Card.Text>
              This site allows you to manage all projects with ease and all in
              one place! Make an account and try it yourself!
            </Card.Text>
          </Card.Body>
        </Card>
      </CardGroup>
